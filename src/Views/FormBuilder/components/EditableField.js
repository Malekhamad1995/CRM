...
import Form from "../reactschema/1/index";
...
class FieldPropertiesEditor extends Component {
  ...
  render() {
    ...
    fType = uiSchema["ui:widget"];
    else
     fType ="Text Field";
    return (
      <div className="panel panel-default field-editor">
        <div className="panel-heading clearfix">
            <strong className="panel-title">Edit {name} -- Field Type: {fType}</strong>
...
function DraggableFieldContainerWithoutIcons(props) {
  const {
    children,
    dragData,
    onDrop
...
if(props.uiSchema.editSchema.fieldType === "extra")
{
    return (
  ...
  return (
    <DraggableFieldContainerWithoutIcons
      draggableType="moved-field"
      droppableTypes={["moved-field", "field"]}
      dragData={props.name}
      onDrop={this.handleDrop.bind(this)}>
