                ...
                <div className={`card-body-section${isExpanded ? ' is-expanded' : ''}`}>
                  <div className='body-title-wrapper'>
                    ...
                    <div className='body-card-tooltip-wrapper'>
                      ...
                      {(((item.status &&
                        item.status.lookupItemName === LeadsStatusEnum.Closed.key) && item && item.leadClass.toLowerCase() === LeadsClassTypesEnum.tenant.value && (
                          <PermissionsComponent
                          ...
                          >
                            <div className='Clone-bbt mx-3'>
                              <Tooltip title={t(`${translationPath}clone`)}>
                                <Fab
                                  size='small'
                                  aria-label={t(`${translationPath}clone`)}
                                  label={t(`${translationPath}clone`)}
