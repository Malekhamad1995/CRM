...
export const DocumentsManagementDialog = ({
  id,
  activeItem,
  reloadData,
  isOpen,
  ...
  const saveHandler = async (event) => {
    ...
    setIsLoading(true);
    const res =
      (activeItem && (await UpdateWorkOrderDocument(activeItem.documentId, state))) ||
      (await CreateWorkOrderDocument(state));
    setIsLoading(false);
...
DocumentsManagementDialog.propTypes = {
...
DocumentsManagementDialog.defaultProps = {
  activeItem: null,
};
