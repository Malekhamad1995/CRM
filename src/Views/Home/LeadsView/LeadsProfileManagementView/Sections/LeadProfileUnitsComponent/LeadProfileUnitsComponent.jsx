...
// import { LeadProfileUnitsCardComponent } from './Sections/LeadProfileUnitsCardComponent/LeadProfileUnitsCardComponent';
      ...
      setUnits({
        result: unitData.result.map((item) => {
          ...
          return {
            ...
            refNumber: `${(unit.ref_number && unit.ref_number) || 'N/A'}`,
            operationType,
            unitStatus:
