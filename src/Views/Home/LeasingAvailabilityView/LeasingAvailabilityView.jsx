...
import { UntZeroMatchingDialog } from '../SalesAvailabilityView/MyLeadsUtilities';
import { UnitMapper } from '../UnitsView/UnitMapper';
import { LeasingAvailabilityTableView } from './MyLeadsUtilities';

const parentTranslationPath = 'LeasingAvailabilityView';
const translationPath = '';
export const LeasingAvailabilityView = () => {
  ...
  const [selectedOrderBy, setSelectedOrderBy] = useState({
    filterBy: orderFilter.LeaseingAvailabilityFilter.filterBy,
    orderBy: orderFilter.LeaseingAvailabilityFilter.orderBy,
  });
  ...
  useTitle(t(`${translationPath}leasing-availability`));
  const getAllMySale = useCallback(async () => {
    setIsLoading(true);
    const res = await GetAvailableLeaseUnitsAdvanceSearch(filter, {
      criteria:
        (filterSearchDto &&
