...
import { CloseLeadDailog } from './CloseLeadDailog/CloseLeadDailog';
...
function CardDetailsComponent({
  ...
  const getDefaultContactImage = (contactType) =>
    ContactTypeEnum[contactType].defaultImg;
  ...
  return (
    <div className='leads-card-detaild-wrapper'>
          ...
          <div>
            ...
            <div className='d-flex-center flex-wrap mb-2'>
              {(activeData &&
                ...
                activeData.contact_name.email_address && (
                  <Button
              ...
              {activeData &&
                activeData.contact_name &&
                activeData.contact_name.mobile && (
                  <Button
            ...
            <div className='d-flex-center mb-3 '>
              <div className='data-schedule-button'>
                <div
                  className={`data-file-button ${dataFile ? 'selected' : ''}`}
                >
                  <Button
                    onClick={() => {
                      setSchedule(false);
                ...
                <div
                  className={`schedule-button ${schedule ? 'selected' : ''}`}
                >
                  <Button
                    onClick={() => {
                      setSchedule(true);
            ...
            {dataFile && (
              <div className='px-3 mb-3 slider-data'>
                ...
                <div className='mb-3'>
                  ...
                  <span className='texts s-gray-primary'>
                    {`  ${activeData.city ? activeData.city.lookupItemName : 'N/A'
                      }`}
                ...
                <div className='mb-3'>
                  ...
                  <span className='texts s-gray-primary'>
                    {` ${activeData.budgetFrom ? activeData.budgetFrom : 'N/A'
                      } - ${activeData.budgetTo ? activeData.budgetTo : 'N/A'
                      }`}
      ...
      <DialogComponent
        ...
        maxWidth='sm'
        dialogContent={
          <span>{t(`${translationPath}MassageLeadsproperty`)}</span>
        }
      />
      ...
      <DialogComponent
        ...
        dialogContent={(
          <div className='my-leads-wrapper'>
            <CloseLeadDailog      translationPath={translationPath} hidebbt={hideLeadsbbt} close={() => setIsOpenclosed(false)} reloadData={relodedata} activeData={activeData} />
          </div>
        )}
