  ...
  useEffect(() => {
    if (Data) {
      const filterData =
        ...
        Data.activityTypeTemplateRecipientTypes.filter((obj) => obj.recipientTypeId === RecipientTypeCoreEnum.AssignTo.key);
      ...
      setSelected(
        filterData && filterData[0] && filterData[0] &&
          ...
          filterData[0].activityTypeTemplateRecipientTypeSources.map((x) => ({
            key: x.notifyById,
            value:
              Object.values(ReminderTypeEnum).findIndex((element) => element.key === x.notifyById) !==
                -1 &&
  ...
  return (
    <div>
      <AutocompleteComponent
        ...
        labelValue='Assign-Notification-by'
