...
export const EditFormCity = ({
  ...
  const saveHandler = async () => {
    setIsLoading(true);
    const toSaveState = {
      imageGalleryType: ImagesGalleryFilterEnum.City.lookupType,
      lookupItemId: +GetParams('id'),
  ...
  return (
    <div className='view-wrapper-editFormCountry'>
      <div className='d-flex-column'>
        ...
        <div>
          <span className=' pb-4 label-wrapper'>{t(`${translationPath}All-images-for-selected-CITY`)}</span>
