    ...
    <div className='unit-profile-remarks-wrapper childs-wrapper'>
      ...
      <div className='mb-2'>
        <PermissionsComponent
          ...
          permissionsId={UnitsSalesPermissions.AddNewRemarksForUnit.permissionsId}
        >
          <ButtonBase
              ...
              <div className='item-section'>
                ...
                <div>
                  ...
                  <div className='d-flex-v-center-h-between w-100'>
                    <PermissionsComponent
                      permissionsList={Object.values(UnitsSalesPermissions)}
                      permissionsId={UnitsSalesPermissions.UeditRemarksInUnit.permissionsId}
                    >
                      <ButtonBase
                    ...
                    <PermissionsComponent
                      permissionsList={Object.values(UnitsSalesPermissions)}
                      permissionsId={UnitsSalesPermissions.DeleteRemarksInUnit.permissionsId}
                    >
                      <ButtonBase
                        className='btns theme-transparent c-gray-primary'
                        onClick={() => {
