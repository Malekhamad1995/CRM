...
export const SummaryRentRelatedComponent = ({
  state,
  selected,
  unitData,
  schema,
        ...
        <div className='summary-box'>
          <div className='summary-details-section'>
            <div className='summary-item-wrapper'>
              ...
              <span className='summary-value'>{(unitData && unitData.id) || 'N/A'}</span>
            </div>
            {/*
            <div className='summary-item-wrapper'>
            ...
            <div className='summary-item-wrapper'>
              <span className='summary-title'>{t(`${translationPath}will-be-rent-to`)}</span>
            ...
            <div className='summary-item-wrapper'>
              <span className='summary-title'>{t(`${translationPath}for-the-rent-price-of`)}</span>
              <span className='summary-value'>{state.rentPerYear || 'N/A'}</span>
            </div>
          </div>
...
SummaryRentRelatedComponent.propTypes = {
