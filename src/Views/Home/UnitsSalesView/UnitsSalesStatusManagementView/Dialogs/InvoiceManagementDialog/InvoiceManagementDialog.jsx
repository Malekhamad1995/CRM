          ...
          <div className='form-item'>
            <Inputs
              ...
              onInputChanged={(event) => {
                ...
                const amountDuePercentage = effectedByNumber ? +(amountDue / effectedByNumber) * 100 : 0;
                const taxPerValue = value ? ((+state.tax) / value) * 100 : 0;
          ...
          <div className='form-item'>
            <Inputs
                ...
                <div className='d-flex-v-center'>
                  ...
                  <Inputs
                    ...
                    onInputChanged={(event) => {
                      ...
                      const effectedValue = (+(effectedByNumber || 0) / 100) * value
                       
                      const taxValue = (+value / 100) * +state.amountExTax;
                      const amountDue = +(taxValue + state.amountExTax);
              ...
              onInputChanged={(event) => {
                ...
                const effectedValue = +(value / state.amountExTax) * 100
                const amountDue = +(value + state.amountExTax);
                const amountDuePercentage = +(+(+amountDue / effectedByNumber) * 100)
                setState({
                  id: 'edit',
                  value: {
          ...
          <div className='form-item'>
            <Inputs
              ...
              onInputChanged={(event) => {
                ...
                const effectedByValue = +(effectedByNumber || 0);
                if (value > effectedByValue) value = effectedByValue;
                const effectedValue = (value / effectedByValue) * 100;
                setState({
                  id: 'edit',
                  value: {
                    ...state,
