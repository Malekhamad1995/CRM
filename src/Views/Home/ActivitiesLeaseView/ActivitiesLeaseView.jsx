...
import {
  ...
  GetLeads,
  getUnits,
  GetAllNotRelatedActivitiesOfTypeLease,
  GetActivitiesWithUnitsOfTypeLease
...
import { ActivitiesManagementDialog } from './ActivitiesLeaseViewUtilities/Dialogs/ActivitiesManagementDialog';
...
export const ActivitiesLeaseView = () => {
  ...
  const getAllActivities = useCallback(async () => {
    ...
    const res = activeActionType === ViewTypes2Enum.tableRelatedView.key ? await GetAllNotRelatedActivitiesOfTypeLease({
    ...
    }) : await GetActivitiesWithUnitsOfTypeLease({
      ...filter, filterBy: orderBy.filterBy, orderBy: orderBy.orderBy, pageIndex: filter.pageIndex + 1, fromDate: activitiesDate.fromDate, toDate: activitiesDate.toDate
    });
