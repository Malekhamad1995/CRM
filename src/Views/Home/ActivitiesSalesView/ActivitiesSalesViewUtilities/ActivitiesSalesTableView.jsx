...
import { TableColumnsFilterComponent, Tables, SwitchComponent } from '../../../../Components';
...
export const ActivitiesSalesTableView = ({
  data,
  onPageIndexChanged,
  onPageSizeChanged,
  filter,
  ...
  const dispatch = useDispatch(); const GetActivityAPI = useCallback(async (activityId) => {
  ...
  useEffect(() => {
    if (activeActionType == 'tableRelatedView' &&
      ...
      tableColumnsFilterResponse[ColumnsFilterPagesEnum.activitySalesRelated.key]
    )
      setSelectedTableFilterColumns({ ...selectedTableFilterColumns, tableRelatedView: tableColumnsFilterResponse[ColumnsFilterPagesEnum.activitySalesRelated.key] });

    else if (activeActionType == 'tableView' && tableColumnsFilterResponse &&
      tableColumnsFilterResponse[ColumnsFilterPagesEnum.activitySalesAll.key])
      setSelectedTableFilterColumns({ ...selectedTableFilterColumns, tableView: tableColumnsFilterResponse[ColumnsFilterPagesEnum.activitySalesAll.key] });
      ...
      <div className='w-100 px-3'>
        ...
        <TableColumnsFilterComponent
          ...
          onSelectedColumnsChanged={(newValue) => {
            ...
            if (localTableColumnsFilterResponse) {
              if (activeActionType && activeActionType === 'tableRelatedView') localTableColumnsFilterResponse[ColumnsFilterPagesEnum.activitySalesRelated.key] = newValue;
              else if (activeActionType && activeActionType === 'tableView') localTableColumnsFilterResponse[ColumnsFilterPagesEnum.activitySalesAll.key] = newValue;
            } else if (activeActionType && activeActionType === 'tableRelatedView') {
              localTableColumnsFilterResponse = {
                [ColumnsFilterPagesEnum.activitySalesRelated.key]: newValue,
              };
            } else if (activeActionType && activeActionType === 'tableView') {
              localTableColumnsFilterResponse = {
                [ColumnsFilterPagesEnum.activitySalesAll.key]: newValue,
              };
            }
        ...
        {!isTableRelatedView && (
          <Tables
            ...
            defaultActions={
              returnPropsByPermissions(ActivitiesSalesPermissions.ViewActivityDetails.permissionsId) ?
...
ActivitiesSalesTableView.propTypes = {
...
ActivitiesSalesTableView.defaultProps = {
