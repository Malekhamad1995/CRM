...
export const ContactsActionSMSDialogsComponent = ({
  isOpenChanged,
  item,
  translationPath,
  ...
  return (
    <div className='w-100 px-3'>
      ...
      <div className='massage-style-box'>
        { showlink && (
        <button
          className='MuiButtonBase-root btns-icon theme-solid bg-green-dark mx-2 mt-3'
          tabIndex='0'
          type='button'
          onClick={() => {
            try {
...
ContactsActionSMSDialogsComponent.propTypes = {
...
ContactsActionSMSDialogsComponent.defaultProps = {
  showlink: false
 };
